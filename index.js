...
carddefaults = [
    ["damageful","pistol.png","Pistol",15,5,1],
    ["damageful","shotgun.png","Shotgun",20,2,10],
    ["damageful","uzi.png","UZI",10,50,10],
    ["weapon","sword.png","Sword",8,"∞",10],
    ["weapon","dagger.png","Dagger",5,"∞",15],
    ["weapon","axe.png","Axe",10,"∞",8],
    ["weapon","bat.png","Bat",8,"∞",5],
    ["legendary","cannon.png","Cannon",35,1,20],
    ["legendary","catapult.png","Catapult",30,3,10],
    ["legendary","wand.png","Magic Wand",20,20,2],
    ["defensive","shield.png","Shield",1,"∞",30],
    ["defensive","demon.png","Devil Armor",-5,20,100],
    ["damageful","spear.png","Spear",14,6,3],
    ["damageful","mace.png","Mace",12,8,5],
...
actioncards = [
    ...
    ["green","nuke.png","Nuke",`Demolishes all held weapons and deals 30 damage to both players`],
]
